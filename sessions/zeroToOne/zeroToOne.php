...
<hr style="border-top: 1px solid #fff;opacity: 0.8;margin-top: 3px;" class="mt-2">
  ...
  <div class="row align-items-center container1 text-center mx-auto" style="max-width: 90%;">
    ...
    <div class="col-12 col-md-6 col-lg-4 speakercard mx-4">
        <img style="width:300px; height:300px;" src="../../img/speakers_new/rajneesh.jpg" alt="">
        <h5 class="mt-2">RAJNEESH ARORA</h5>
          <hr style="width:35%;height:1.5px;color:red;opacity:1;margin:auto;">
          <h6 class="my-2 desig pb-3">Co-Founder of Spice Money</h6>
      </div>

      <div class="col-12 col-md-6 col-lg-4 speakercard mx-4">
        <img style="width:300px; height:300px;" src="../../img/speakers_new/upendra.png" alt="">
        <h5 class="mt-2">UPENDRA MARDIKAR</h5>
          <hr style="width:35%;height:1.5px;color:red;opacity:1;margin:auto;">
          <h6 class="my-2 desig pb-3">Chief Security Officer at Snap Finance</h6>
      </div>

      
  </div>
  <div class="text-center">
  <a href="zeroToOneReg.php" target="_blank"><button type="button" class="btn btn3">
       Register Now
      </button></a></div>
