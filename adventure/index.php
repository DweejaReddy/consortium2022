...
<link rel="manifest" href="img/favicon_io/site.webmanifest">
    <title>ADVENTURE | Consortium '22, E-CELL, VNIT, 2022</title>
</head>
...
<hr style="border-top: 1px solid #fff;opacity: 0.8;margin-top: 3px;" class="mt-2">
    <section class="d-none d-md-block my-5" id="home">
        <div class="about row align-items-center py-4 mx-auto" style="max-width: 80%;">
            ...
            <div class="col-12 col-md-5 text-white ml-4 pt-4">
                <h1  style="font-weight: 900;text-shadow: 0px 1px, 1px 0px, 1px 1px;font-size: 3.5rem;" data-aos="fade-down" data-aos-duration="2000">AD-VENTURE</h1>
                ...
                <p style="color: #D5242A;font-size: 1.4vw;">Ad-venture is an advertisement making competition that would test one's skill of coupling creativity with their marketing strategy and creating an advertisement that would attract customers to buy your company product.
                ...
                <p style="color: rgb(160, 160, 160);font-size: 1.3vw;" class="ml-6 mt-2">Last Date: 18th March</p></div>
    ...
    <section class="d-block d-md-none my-5" id="home_mob">
        <div class="about row align-items-center py-4 mx-auto d-block d-lg-none">
            <h1 class="text-center text-white mb-4"  style="font-weight: 900;font-size: 3rem;">AD-VENTURE</h1>
            <div class="col-12 col-md-5">
            ...
            <div class="col-12 col-md-5 text-white text-center pt-3">
                ...
                <p style="color: #D5242A;font-size: 3.7vw;">Ad-venture is an advertisement making competition that would test one's skill of coupling creativity with their marketing strategy and creating an advertisement that would attract customers to buy your company product.
                ...
                <div class="text-center mt-3 px-5">
                    ...
                    <p style="color: rgb(160, 160, 160);font-size: 4.2vw;" class=" mt-2">Last Date: 18th March</p></div>
                </div></div>
        </div>
    </section>
...
Our experts will shortlist the contenders for the first round based on their critical thinking, decisiveness, business-related strategizing, and creative thinking.
    ...
    <section>
        <div class="text-center about mx-auto my-5 py-5" id="struct" style="max-width: 80%;">
            ...
            <ul class="text-center reason mx-auto">
                ...
                Students may work together in groups or individual
                </li>
                <li class="py-2 container">
                Participants will have to create 40 sec to 1 min advertisement video
                </li>
                <li class="py-2 container">
                You can choose topic of advertisement by your own
                </li>
                <li class="py-4 container">
                Entries will be judged on practicality of ideas presented , level of marketing used and details , feasibility of  concept executed and overall impression .
                </li>
            </ul>
        </div>
    </section>
